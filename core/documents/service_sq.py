...
class ServiceDoc(Document):
    ...
    category = fields.NestedField(
        properties={
            ...
            "description": fields.TextField(attr="description_sq", analyzer=html_strip),
        }
    )
    ...
    hospitals = fields.NestedField(
        properties={
            "id": fields.IntegerField(),
            "name": fields.TextField(
                attr="name_sq", fields={"raw": fields.KeywordField()}
            ),
            "description": fields.TextField(attr="description_sq", analyzer=html_strip),
            "location": fields.ObjectField(
                properties={
                    ...
                    "city": fields.TextField(attr="city_sq"),
                    "country": fields.TextField(attr="country_sq"),
